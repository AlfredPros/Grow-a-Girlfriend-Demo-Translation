    ...
    for id_d, d in enumerate(dialogue):
        if d.who == None: # Narrator
            ...
            hbox:
                ...
                vbox:
                    yalign 1.0
                    if d.who != MC_Name and previous_d_who != d.who:    # Same as above, but also mentions the name with the profile pic
                        hbox:
                            ...
                            # text "Today at X":
                            #     yalign 1
                            #     font "fonts/Roboto-Regular.ttf"n 
                            #     size 15 xoffset 25 yoffset 12
                    elif d.who == MC_Name:
                        hbox:
                            text playername:
                                    yalign 1
...
style phoneFrame_frame:
    background Transform("phone_background.png", xcenter=0.5,yalign=0.6)
    foreground Transform("phone_foreground.png", xcenter=0.5,yalign=0.6)
